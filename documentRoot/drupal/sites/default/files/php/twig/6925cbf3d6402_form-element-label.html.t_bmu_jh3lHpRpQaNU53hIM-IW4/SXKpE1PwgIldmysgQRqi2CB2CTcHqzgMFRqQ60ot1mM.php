...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/var/www/drupal/core/modules/system/templates/form-element-label.html.twig");
    }
